"""
Example usage of the InterviewQuestionGenerator module.
"""
...
def main():
    """Example of how to use the question generator."""
    ...
    # Example company and job description
...
Canada Salary Range/Hourly Rate for Internships: The range of pay for internships in Canada is $22-$27 CAD per hour. Actual compensation will be determined based on location, and other factors permitted by law.
...
External candidates can apply for this role through the RV Tech Careers site (https://rivianvw.tech/#careers). If you are a current employee, please apply through our internal job board (https://internal-careers-rivian.icims.com/).
...
Please note this job posting represents an open, active vacancy. Additionally, we are currently not accepting applications from third party application services.
    """
    
    print(f"Generating questions for {company_name}...\n")
    
    # Generate questions
    questions = generator.generate_questions(company_name, job_description)
    
    # Display formatted questions
    formatted = generator.format_questions_for_display(questions)
    print(formatted)
    
    # You can also access questions by category
    print("\nAccessing questions by category:")
    print(f"Introduction: {questions['introduction']}")
    print(f"\nRegular: {questions['regular']}")
