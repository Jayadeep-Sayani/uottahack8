...
export default function FeedbackPage() {
  ...
  useEffect(() => {
    const fetchFeedback = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/get-overall-feedback', {
          method: 'GET',
          headers: {
      ...
      <div className="feedback-container">
        ...
        {feedback?.confidence_score && (
          <div className="rating-card">
            ...
            <div className="rating-label">Confidence Score</div>
            <div className="rating-text">{feedback.confidence_score}/10</div>
            <div className="rating-description">Based on your overall interview performance</div>
          </div>
        )}

        {/* Summary */}
        {feedback?.summary && (
          <div className="section-card full-width-card" style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: '#475569', lineHeight: '1.8', margin: 0 }}>
              {feedback.summary}
            </p>
          </div>
        )}
            ...
            {feedback?.strengths?.map((strength, index) => (
              <div key={index} className="strength-item">
                ...
                <div className="strength-description">
                  {typeof strength === 'string' ? strength : (strength.title || strength.description || strength)}
                </div>
              </div>
            ))}
          </div>
            ...
            {feedback?.areas_for_improvement?.map((area, index) => (
              <div key={index} className="weakness-item">
                ...
                <div className="weakness-description">
                  {typeof area === 'string' ? area : (area.title || area.description || area)}
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Consistency Analysis & Communication Style */}
        {(feedback?.consistency_analysis || feedback?.communication_style) && (
          <div className="content-grid">
            {feedback?.consistency_analysis && (
              <div className="section-card">
                <div className="section-header">
                  ...
                  <h2 className="section-title">Consistency Analysis</h2>
                </div>
        ...
        {feedback?.final_recommendation && (
          <div className="section-card full-width-card" style={{ marginTop: '2rem' }}>
            <div className="section-header">
              <div className="section-icon success">
                <Lightbulb size={24} />
              </div>
            ...
            <p style={{ fontSize: '1.1rem', color: '#1a1a1a', lineHeight: '1.8', margin: 0, fontWeight: 500 }}>
              {feedback.final_recommendation}
            </p>
          </div>
        )}
